<div class="main-panel">
    <div class="content-wrapper">
        ...
        <div class="row mb-3">
          <div class="col-md-3">
            <button id="btnExportIngresos" class="btn btn-success">Exportar a Excel</button>
          </div>
        </div>
...
<script>
document.getElementById('btnExportIngresos').addEventListener('click', function() {
  let month = document.getElementById('monthFilter').value;
  let year = document.getElementById('yearFilter').value;
  let url = '<?= base_url('finanzas/exportIngresos') ?>?month=' + month + '&year=' + year;
