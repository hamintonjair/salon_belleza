...
class VentaModel extends Model
{
    ...
    /**
     * Suma todos los ingresos filtrados por mes/año.
     */
    public function sumarIngresos($month = null, $year = null)
    {
        ...
        // Sumar valor_total
        return array_reduce($data, fn($carry, $item) => $carry + floatval($item['valor_total']), 0);
    }
