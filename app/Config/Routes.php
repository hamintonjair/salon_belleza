...
// EGRESOS
$routes->post('egresos/guardar', 'FinanzasController::guardarEgreso');
// CALENDARIO
...
$routes->post('pagos_empleados/pagarEmpleado/(:num)', 'PagosEmpleados::pagarEmpleado/$1');
...
$routes->get('pagos_empleados/getResumenPago/(:num)', 'PagosEmpleados::getResumenPago/$1');
$routes->get('pagos_empleados/getPagosRealizados/(:num)', 'PagosEmpleados::getPagosRealizados/$1');
$routes->get('pagos_empleados/getPrestamosEmpleado/(:num)', 'PagosEmpleados::getPrestamosEmpleado/$1');
...
// FINANZAS
$routes->get('finanzas/ingresos', 'FinanzasController::ingresos');
$routes->get('finanzas/egresos', 'FinanzasController::egresos');
$routes->get('finanzas/exportIngresos', 'FinanzasController::exportIngresos');
$routes->get('finanzas/getIngresos', 'FinanzasController::getIngresos');
$routes->get('finanzas/getEgresos', 'FinanzasController::getEgresos');
$routes->get('finanzas/getIngresosMensual', 'FinanzasController::getIngresosMensual');
$routes->get('finanzas/getEgresosMensual', 'FinanzasController::getEgresosMensual');
$routes->get('finanzas/getSaldo', 'FinanzasController::getSaldo');
$routes->post('finanzas/retirar', 'FinanzasController::postEgreso');
